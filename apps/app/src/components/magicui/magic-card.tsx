...
const MagicCard = ({
  ...
  return (
    ...
    >
      {/* Border */}
      <div className="pointer-events-none absolute inset-0 h-full w-full rounded-2xl bg-border bg-[radial-gradient(var(--mask-size)_circle_at_var(--mouse-x)_var(--mouse-y),hsla(12,6.5%,15.1%,0),hsla(47.9,95.8%,53.1%,0.1),transparent_100%)] transition-opacity duration-500" />
